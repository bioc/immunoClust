...
events(meta,cls)
@
and first sort the meta-clusters according to the scatter parameter
into of the five major areas
...
tbl <- meta.numEvents(meta, out.all=FALSE, out.unclassified=F)
tbl[,1:5]
@
